...
<section class="section contact-page">
  <div class="container">
    ...
    <div class="contact-center">
      <h3 class="contact-center__title">Informações de Contato</h3>
      ...
      <div class="contact-cards">
        ...
        <a class="contact-card" href="https://www.linkedin.com/in/gutemberganalista/" target="_blank" rel="noreferrer">
          <div class="contact-card__icon"><i class="fa-brands fa-linkedin-in"></i></div>
          <div class="contact-card__text">
        ...
        <div class="contact-card contact-card--static">
          <div class="contact-card__icon"><i class="fa-regular fa-clock"></i></div>
          <div class="contact-card__text">
